...
(async() => {
 ...
 for (var i=0;i<x.days.length;i++) {
    ...
    data.innerHTML = "DATE: " + x.days[i].datetime + " || CONDITIONS: " + x.days[i].conditions + " || TEMP: " + x.days[i].temp + "C";
    weather.appendChild(data);
 }
//  var list = document.getElementById("list-group");
 
if (x.days[0].conditions == "Partially cloudy") {
    document.querySelector('body').style.backgroundImage="url(images/PartiallyCLoud.jpeg)";
    ...
    document.querySelector('body').style.backgroundImage="url(images/Clear.jpeg)";
 }
})()
